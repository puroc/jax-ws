...
public class DepartmentServiceAgentService extends Service {
    ...
    static {
        URL url = DepartmentServiceAgentService.class.getResource("./WEB-INF/wsdl/DepartmentService.xml");
        if (url == null) {
            url = DepartmentServiceAgentService.class.getClassLoader().getResource("./WEB-INF/wsdl/DepartmentService.xml");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(DepartmentServiceAgentService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "./WEB-INF/wsdl/DepartmentService.xml");
        }       
        WSDL_LOCATION = url;
    }
